...
const COMPANIES: Record<CompanyKey, Company> = {
    ...
    projects: [
      {
        id: 'o1',
        label: '안드로이드 북카페',
        dates: '2015.03 ~ 2015.08',
        desc: 'Android · 바코드 스캔 · Naver API · 바코드 프린터',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'o2',
        label: '유연 좌석 시스템',
        dates: '2015.08 ~ 2015.11',
        desc: 'Spring · jQuery · 드래그앤드롭 좌석 배치',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'o3',
        label: '독서통합시스템',
        dates: '2016.03 ~ 2016.08',
        desc: 'Spring · RFID 사원증 기반 도서 대출 시스템',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'o4',
        ...
        desc: 'Spring · RFID 기반 행사 출석 관리',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'o5',
        label: 'O2O 세탁 서비스',
        dates: '2017.01 ~ 2017.11',
        desc: 'Android · 세탁 주문/수거/배송 O2O 앱',
        documents: DEFAULT_DOCS,
      },
    ],
  },
  cyberi: {
    name: '사이버이메지네이션',
    period: '2018.01 ~ 2021.07',
    role: '개발팀 · 대리 · 3년 7개월',
    projects: [
      {
        id: 'c3',
        label: 'KRX 홈페이지 운영',
        dates: '2018.01 ~ 2019.12',
        desc: '무중단 운영 · Scouter APM · coreFRAME',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'c4',
        label: 'webPonent 차트/그리드',
        dates: '2020.01 ~ 2020.06',
        desc: 'jQuery · Vanilla JS · 원통/선형/방사형 차트 고도화',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'c5',
        label: '사내 그룹웨어 모바일',
        dates: '2020.05 ~ 2020.07',
        desc: 'Flutter · 기존 웹 그룹웨어 → Android/iOS 앱 전환',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'c2',
        label: 'KRX 대용량 다운로드',
        dates: '2020.06 ~ 2020.07',
        desc: 'Electron · 이어받기 · 모바일 인증',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'c6',
        label: '한진택배 D-Bridge API',
        dates: '2020.08 ~ 2020.12',
        desc: 'DBridge(Java) · 운송/국제택배/LG안심번호 API',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'c1',
    ...
    projects: [
      {
        ...
        dates: '2021.08 ~ 2021.10',
        desc: 'Vue · 데이터 관리/설정/관리 화면 개발',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'i4',
        label: 'WINS RPA 유지관리',
        dates: '2021.10',
        desc: 'Vue · Node · 주기적 프로세스 자동화 (UI PATH 유사)',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'i5',
  ...
  ecomarine: {
    ...
    projects: [
      {
        id: 'e1',
        label: 'OceanLook 선박 모니터링',
        dates: '2023.08 ~ 2024.11',
        desc: 'Nuxt3 · Leaflet · 실시간 선박 추적 · 커스텀 타일서버',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'e2',
      ...
      },
      {
        ...
        label: '로그북 (CII 탄소배출)',
        dates: '2023.08 ~ 2024.11',
        desc: 'CII 등급 자동 계산 · 탄소 배출 실시간 모니터링',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'e4',
        label: '트레이더스 물류시스템',
        dates: '2023.08 ~ 2024.11',
        desc: '견적/예약/화물/청구/문서 관리 · 팀 설계 주도',
        documents: DEFAULT_DOCS,
      },
    ],
  },
    ...
    projects: [
      {
        id: 'g1',
        label: '가스링크 1차 오픈',
        dates: '2024.11 ~ 2025.04',
        desc: 'React · Zustand · 검침/점검/현장결제/공통업무',
        documents: DEFAULT_DOCS,
      },
      {
        id: 'g2',
        label: '가스링크 2차 개발',
        dates: '2025.04 ~ 2025.10',
        desc: '방문 · 계량기 교체 · 체납 관리 (개발중)',
        documents: DEFAULT_DOCS,
      },
    ],
  },
